...
var o26153 = temp__5718__auto__;
var temp__5718__auto____$1 = (o26153["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o26154 = temp__5718__auto____$1;
return (o26154["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__25265__auto__ = f;
return (o__25265__auto__["toString"]).call(o__25265__auto__);
} else {
return "";
}
}catch (e26155){var _ = e26155;
return "";
}});
...
try{var o__25265__auto___26157 = t;
(o__25265__auto___26157["cljs$lang$ctorPrWriter"]).call(o__25265__auto___26157,t,writer);
}catch (e26156){var __26158 = e26156;
}
...
var char_code = (function (){var o__25265__auto__ = (new String(char$));
return (o__25265__auto__["charCodeAt"]).call(o__25265__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__25265__auto__ = String;
return (o__25265__auto__["fromCharCode"]).call(o__25265__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__26159 = num_code;
switch (G__26159) {
case (1):
return (185);
...
var o__25265__auto__ = String;
return (o__25265__auto__["fromCharCode"]).call(o__25265__auto__,superscript_code);
});
/**
...
}catch (e26161){var _e__25272__auto__ = e26161;
return false;
}})())){
...
var vec__26162 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__26162,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o26165 = temp__5718__auto__;
var temp__5718__auto____$1 = (o26165["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o26166 = temp__5718__auto____$1;
return (o26166["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__26169){
var vec__26170 = p__26169;
var ns_detector = cljs.core.nth.call(null,vec__26170,(0),null);
...
var G__26176 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__26177 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__26176;
remaining_tokens = G__26177;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq26167){
var G__26168 = cljs.core.first.call(null,seq26167);
var seq26167__$1 = cljs.core.next.call(null,seq26167);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26168,seq26167__$1);
});
...
var vec__26181 = cljs.core.split_with.call(null,(function (p1__26180_SHARP_){
return cljs.core.not_EQ_.call(null,p1__26180_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__26181,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__26181,(1),null);
...
var vec__26187 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__26187,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__26187,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__26190 = cljs.core.rest.call(null,remaining_tokens);
var G__26191 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__26190;
name_tokens = G__26191;
continue;
} else {
...
var vec__26194 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__26194,(0),null);
var arity = cljs.core.nth.call(null,vec__26194,(1),null);
var vec__26197 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__26197,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__26197,(1),null);
var vec__26200 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__26200,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__26200,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__26200,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__26200,(3),null);
...
var vec__26206 = result;
var munged_ns = cljs.core.nth.call(null,vec__26206,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__26206,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__26206,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__26206,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__26206,(4),null);
var arity = cljs.core.nth.call(null,vec__26206,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__26210 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__26210,(0),null);
var args = cljs.core.nth.call(null,vec__26210,(1),null);
var vec__26213 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__26213,(0),null);
var name = cljs.core.nth.call(null,vec__26213,(1),null);
...
var G__26216 = (arity + (1));
var G__26217 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__26218){
var vec__26219 = p__26218;
var arity = cljs.core.nth.call(null,vec__26219,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__26219,(1),null);
...
return cljs.core.get.call(null,arities,p1__26222_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__26223_SHARP_);
...
var args__4736__auto__ = [];
var len__4730__auto___26230 = arguments.length;
var i__4731__auto___26231 = (0);
while(true){
if((i__4731__auto___26231 < len__4730__auto___26230)){
args__4736__auto__.push((arguments[i__4731__auto___26231]));

var G__26232 = (i__4731__auto___26231 + (1));
i__4731__auto___26231 = G__26232;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__26226){
var vec__26227 = p__26226;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__26227,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq26224){
var G__26225 = cljs.core.first.call(null,seq26224);
var seq26224__$1 = cljs.core.next.call(null,seq26224);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26225,seq26224__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__26235__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__26235__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__26235__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__26235__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__26236 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__26236,(0),null);
var fn_name = cljs.core.nth.call(null,vec__26236,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__26236,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__26236,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__26236,(4),null);
var arity = cljs.core.nth.call(null,vec__26236,(5),null);
...
var o__25265__auto__ = f;
return (o__25265__auto__["getBasis"]).call(o__25265__auto__);
});
/**
...
}catch (e26240){var _e__25272__auto__ = e26240;
...
var G__26241 = (obj[cljs.core.first.call(null,path)]);
var G__26242 = cljs.core.rest.call(null,path);
obj = G__26241;
path = G__26242;
continue;
} else {
...
return (function (accum,p__26243){
var vec__26244 = p__26243;
var bit = cljs.core.nth.call(null,vec__26244,(0),null);
var protocol = cljs.core.nth.call(null,vec__26244,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__26247){
var vec__26248 = p__26247;
var ns = cljs.core.nth.call(null,vec__26248,(0),null);
var name = cljs.core.nth.call(null,vec__26248,(1),null);
var selector = cljs.core.nth.call(null,vec__26248,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__26253,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__26253,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__26253,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__26251_SHARP_){
return (obj[cljs.core.first.call(null,p1__26251_SHARP_)]);
});})(name,sorted_matches,vec__26253,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1582560149054
