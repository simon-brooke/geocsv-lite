...
var o26154 = temp__5718__auto__;
var temp__5718__auto____$1 = (o26154["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o26155 = temp__5718__auto____$1;
return (o26155["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__25266__auto__ = f;
return (o__25266__auto__["toString"]).call(o__25266__auto__);
} else {
return "";
}
}catch (e26156){var _ = e26156;
return "";
}});
...
try{var o__25266__auto___26158 = t;
(o__25266__auto___26158["cljs$lang$ctorPrWriter"]).call(o__25266__auto___26158,t,writer);
}catch (e26157){var __26159 = e26157;
}
...
var char_code = (function (){var o__25266__auto__ = (new String(char$));
return (o__25266__auto__["charCodeAt"]).call(o__25266__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__25266__auto__ = String;
return (o__25266__auto__["fromCharCode"]).call(o__25266__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__26160 = num_code;
switch (G__26160) {
case (1):
return (185);
...
var o__25266__auto__ = String;
return (o__25266__auto__["fromCharCode"]).call(o__25266__auto__,superscript_code);
});
/**
...
}catch (e26162){var _e__25273__auto__ = e26162;
return false;
}})())){
...
var vec__26163 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__26163,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o26166 = temp__5718__auto__;
var temp__5718__auto____$1 = (o26166["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o26167 = temp__5718__auto____$1;
return (o26167["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__26170){
var vec__26171 = p__26170;
var ns_detector = cljs.core.nth.call(null,vec__26171,(0),null);
...
var G__26177 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__26178 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__26177;
remaining_tokens = G__26178;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq26168){
...
var vec__26182 = cljs.core.split_with.call(null,(function (p1__26181_SHARP_){
return cljs.core.not_EQ_.call(null,p1__26181_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__26182,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__26182,(1),null);
...
var vec__26188 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__26188,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__26188,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__26191 = cljs.core.rest.call(null,remaining_tokens);
var G__26192 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__26191;
name_tokens = G__26192;
continue;
} else {
...
var vec__26195 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__26195,(0),null);
var arity = cljs.core.nth.call(null,vec__26195,(1),null);
var vec__26198 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__26198,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__26198,(1),null);
var vec__26201 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__26201,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__26201,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__26201,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__26201,(3),null);
...
var vec__26207 = result;
var munged_ns = cljs.core.nth.call(null,vec__26207,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__26207,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__26207,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__26207,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__26207,(4),null);
var arity = cljs.core.nth.call(null,vec__26207,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__26211 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__26211,(0),null);
var args = cljs.core.nth.call(null,vec__26211,(1),null);
var vec__26214 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__26214,(0),null);
var name = cljs.core.nth.call(null,vec__26214,(1),null);
...
var G__26217 = (arity + (1));
var G__26218 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__26219){
var vec__26220 = p__26219;
var arity = cljs.core.nth.call(null,vec__26220,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__26220,(1),null);
...
return cljs.core.get.call(null,arities,p1__26223_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__26224_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__26227){
var vec__26228 = p__26227;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__26228,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq26225){
var G__26226 = cljs.core.first.call(null,seq26225);
var seq26225__$1 = cljs.core.next.call(null,seq26225);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26226,seq26225__$1);
});
...
var G__26234 = arg;
var G__26234__$1 = (((G__26234 instanceof cljs.core.Keyword))?G__26234.fqn:null);
switch (G__26234__$1) {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__26236__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__26236__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__26236__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__26236__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__26237 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__26237,(0),null);
var fn_name = cljs.core.nth.call(null,vec__26237,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__26237,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__26237,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__26237,(4),null);
var arity = cljs.core.nth.call(null,vec__26237,(5),null);
...
var o__25266__auto__ = f;
return (o__25266__auto__["getBasis"]).call(o__25266__auto__);
});
/**
...
}catch (e26241){var _e__25273__auto__ = e26241;
...
var G__26242 = (obj[cljs.core.first.call(null,path)]);
var G__26243 = cljs.core.rest.call(null,path);
obj = G__26242;
path = G__26243;
continue;
} else {
...
return (function (accum,p__26244){
var vec__26245 = p__26244;
var bit = cljs.core.nth.call(null,vec__26245,(0),null);
var protocol = cljs.core.nth.call(null,vec__26245,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__26248){
var vec__26249 = p__26248;
var ns = cljs.core.nth.call(null,vec__26249,(0),null);
var name = cljs.core.nth.call(null,vec__26249,(1),null);
var selector = cljs.core.nth.call(null,vec__26249,(2),null);
...
return (function (p__26253){
var vec__26254 = p__26253;
var munged_name = cljs.core.nth.call(null,vec__26254,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__26254,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__26254,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__26252_SHARP_){
return (obj[cljs.core.first.call(null,p1__26252_SHARP_)]);
});})(name,sorted_matches,vec__26254,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1582812679395
