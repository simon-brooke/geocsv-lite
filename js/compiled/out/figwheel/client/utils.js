...
return (new CustomEvent(event_name,(function (){var obj28451 = ({"detail":data});
return obj28451;
})()));
} else {
...
var f = (function (){var pred__28458 = cljs.core._EQ_;
var expr__28459 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__28458.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__28459))){
return ((function (pred__28458,expr__28459){
return (function (p1__28452_SHARP_){
return console.warn(p1__28452_SHARP_);
});
;})(pred__28458,expr__28459))
} else {
if(cljs.core.truth_(pred__28458.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__28459))){
return ((function (pred__28458,expr__28459){
return (function (p1__28453_SHARP_){
return console.debug(p1__28453_SHARP_);
});
;})(pred__28458,expr__28459))
} else {
if(cljs.core.truth_(pred__28458.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__28459))){
return ((function (pred__28458,expr__28459){
return (function (p1__28454_SHARP_){
return console.error(p1__28454_SHARP_);
});
;})(pred__28458,expr__28459))
} else {
return ((function (pred__28458,expr__28459){
return (function (p1__28455_SHARP_){
return console.log(p1__28455_SHARP_);
});
;})(pred__28458,expr__28459))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__28462){
...
var eval_fn = cljs.core.get.call(null,map__28463__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__28465_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__28467,(0),null);
var v = cljs.core.nth.call(null,vec__28467,(1),null);
...
//# sourceMappingURL=utils.js.map?rel=1582812681035
